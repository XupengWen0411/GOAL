...
//	OutputStreamWriter out = null;
	 ...
	 * @throws IOException 
	 */
	public BW4TAgent(String agentId, RemoteEnvironment env) throws IOException {
...
//			Parameter[] zParam = Translator.getInstance().translate2Parameter(z);
			Parameter[] parameters = new Parameter[2];
			parameters[0] = xParam[0];
			parameters[1] = yParam[0];
//			parameters[2] = zParam[0];
	...
	@Override
	public void climb(String entity, Numeral high) throws ActException {
...
//		}
		...
		try {
			bw4tenv.performEntityAction(entityId, new Action("climb", high));
		} catch (RemoteException e) {
			ActException ex = new ActException("climb failed", e);
			ex.setType(ActException.FAILURE);
			throw ex;
		}
	}
