...
public class RemoteEnvironment implements EnvironmentInterfaceStandard, EnvironmentListener {
	...
	private static List<Percept> m_percept = new ArrayList<>();
	/**
	...
	private void startEntityGUI(String agentId, String entityId)
			throws EntityException, AgentException, RelationException, IOException {
	...
	public static void main(String[] args) {
		...
		LOGGER.info("connecting C++ UI...");
		try {			  
	        UAVHandler handler = new UAVHandler();
		} catch (IOException e) {
	...
	public static void setPercepts(List<Percept> percepts){
		m_percept=percepts;
