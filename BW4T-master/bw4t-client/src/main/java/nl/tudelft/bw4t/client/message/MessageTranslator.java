...
public class MessageTranslator {
    ...
    static {
        ...
        stringToMessage.put("I am going to ", new CommandAreaColor(MessageType.GOINGTOROOM));
        stringToMessage.put("I have a ", new CommandAreaColor(MessageType.HASCOLOR));
        ...
        stringToMessage.put("empty", new CommandArea(MessageType.ROOMISEMPTY));
        stringToMessage.put("Is anybody going to", new CommandArea(MessageType.ISANYBODYGOINGTOROOM));
        ...
        stringToMessage.put("I am getting", new CommandAreaColor(MessageType.AMGETTINGCOLOR));
        stringToMessage.put("go to", new CommandAreaColorPlayer(MessageType.GOTOROOM));
        stringToMessage.put("find a", new CommandAreaColorPlayer(MessageType.FINDCOLOR));
        stringToMessage.put("get the", new CommandAreaColorPlayer(MessageType.GETCOLORFROMROOM));
        ...
        stringToMessage.put("What is in ", new CommandArea(MessageType.WHATISINROOM));
        stringToMessage.put("Has anybody checked", new CommandArea(MessageType.HASANYBODYCHECKEDROOM));
        stringToMessage.put("Who is in ", new CommandArea(MessageType.WHOISINROOM));
        stringToMessage.put("I am in ", new CommandArea(MessageType.INROOM));
        ...
        stringToMessage.put("I am waiting outside", new CommandArea(MessageType.AMWAITINGOUTSIDEROOM));
        stringToMessage.put("are you close", new CommandAreaColorPlayer(MessageType.AREYOUCLOSE));
        stringToMessage.put("will you be long", new CommandAreaColorPlayer(MessageType.WILLYOUBELONG));
        stringToMessage.put("I am at a", new CommandColor(MessageType.ATBOX));
        stringToMessage.put("I want to go to ", new CommandArea(MessageType.IWANTTOGO));
        stringToMessage.put("You forgot me in ", new CommandArea(MessageType.YOUFORGOTME));
        ...
        stringToMessageEquals.put("OK", new CommandArea(MessageType.OK));
        ...
        messageCommands.put(MessageType.GOINGTOROOM, new CommandGoingToArea());
        messageCommands.put(MessageType.ROOMISEMPTY, new CommandAreaIsEmpty());
        messageCommands.put(MessageType.ISANYBODYGOINGTOROOM, new CommandIsAnybodyGoingToArea());
        messageCommands.put(MessageType.WHATISINROOM, new CommandWhatIsInArea());
        messageCommands.put(MessageType.HASANYBODYCHECKEDROOM, new CommandHasAnybodyCheckedArea());
        messageCommands.put(MessageType.WHOISINROOM, new CommandWhoIsInArea());
        messageCommands.put(MessageType.INROOM, new CommandInArea());
        ...
        messageCommands.put(MessageType.ROOMCONTAINS, new CommandAreaContains());
        messageCommands.put(MessageType.ROOMCONTAINSAMOUNT, new CommandAreaContainsAmount());
        messageCommands.put(MessageType.ATBOX, new CommandAtBox());
        messageCommands.put(MessageType.AMWAITINGOUTSIDEROOM, new CommandAmWaitingOutsideArea());
        messageCommands.put(MessageType.PUTDOWN, new CommandPutDown());
        messageCommands.put(MessageType.GOTOROOM, new CommandGotoArea());
        messageCommands.put(MessageType.FINDCOLOR, new CommandFindColor());
        messageCommands.put(MessageType.GETCOLORFROMROOM, new CommandGetColorFromArea());
     ...
     */
    static String findAreaId(String message) {
