...
public final class HallwayMenu {
    ...
    public static void buildPopUpMenuForHallway(BW4TClientGUI gui, String gotohall) {
        ...
        menuItem.addActionListener(new GotoPositionActionListener(new Point( (gui.getSelectedLocation().getX() / set
                .getScale()),  (gui.getSelectedLocation().getY() / set.getScale()),0.0), gui.getController()));
