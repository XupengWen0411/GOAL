...
import nl.tudelft.bw4t.environmentstore.editor.view.AreaMenu;
...
public class ZoneMenuController {
    ...
    public void attachListenersToZoneMenu(ZoneMenu menu,
        ...
        attachListenerToZoneMenuItem(menu.getMenuItemZoneArea(), mapcontroller,
    ...
    /**
     * this method attaches all the listeners to the Area Menu. 
     * @param menu the menu to which the listener is attached
     * @param mapcontroller controller of the map
     */
    public void attachListenersToAreaMenu(AreaMenu menu,
            MapPanelController mapcontroller) {

        attachListenersToZoneMenu(menu, mapcontroller);

        attachListenerToAreaMenuItem(menu.getMenuItemDoorSideEast(),
                mapcontroller, ZoneModel.EAST);

        attachListenerToAreaMenuItem(menu.getMenuItemDoorSideNorth(),
                mapcontroller, ZoneModel.NORTH);

        attachListenerToAreaMenuItem(menu.getMenuItemDoorSideSouth(),
                mapcontroller, ZoneModel.SOUTH);

        attachListenerToAreaMenuItem(menu.getMenuItemDoorSideWest(),
     ...
     */
    private void attachListenerToAreaMenuItem(final JMenuItem item,
