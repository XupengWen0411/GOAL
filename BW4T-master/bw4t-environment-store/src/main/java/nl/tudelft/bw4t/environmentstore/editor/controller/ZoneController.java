...
public class ZoneController extends MouseAdapter implements ChangeListener {
     ...
     * otherArea are ignored, assuming that the original coordinates of our room
     * are correct.
     * 
     * @param otherArea the room to be set
     */
    public void setValue(ZoneController otherArea) {
        setColors(otherArea.getColors());
    }
