...
public class ZoneMenuControllerTest {
    ...
    public void setUp() {
        ...
        roomMenu = new AreaMenu(mapController) {
            @Override
            public void update() {
                // For testing purposes only.
            }
    ...
    public void attachZoneListenersTest() {
        ...
        assertFalse(zoneMenu.getMenuItemZoneArea().getActionListeners()[0].equals(null));
    }
    ...
    @Test
    public void attachAreaListenersTest() {
        menuController.attachListenersToAreaMenu(roomMenu, mapController);
    ...
    @Test
    public void attachAreaListenersActionTest() {
        menuController.attachListenersToAreaMenu(roomMenu, mapController);
