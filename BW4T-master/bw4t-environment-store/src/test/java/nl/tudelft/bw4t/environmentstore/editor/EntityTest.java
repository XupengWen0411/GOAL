...
public class EntityTest {
    ...
    public void LocationOfEntity1Test() {
        NewMap map = nl.tudelft.bw4t.environmentstore.editor.model.MapConverter.createMap(model);
        assertTrue(map.getEntities().get(0).getPosition().equals(new Point(95-2.5,95-2.5,0.0)));
    }
    
    @Test
    public void LocationOfEntity2Test() {
        NewMap map = nl.tudelft.bw4t.environmentstore.editor.model.MapConverter.createMap(model);
        assertTrue(map.getEntities().get(1).getPosition().equals(new Point(95+2.5,95-2.5,0.0)));
    }
    
    @Test
    public void LocationOfEntity3Test() {
        NewMap map = nl.tudelft.bw4t.environmentstore.editor.model.MapConverter.createMap(model);
        assertTrue(map.getEntities().get(2).getPosition().equals(new Point(95-2.5,95+2.5,0.0)));
    }
    
    @Test
    public void LocationOfEntity4Test() {
        NewMap map = nl.tudelft.bw4t.environmentstore.editor.model.MapConverter.createMap(model);
        assertTrue(map.getEntities().get(3).getPosition().equals(new Point(95+2.5,95+2.5,0.0)));
    }
