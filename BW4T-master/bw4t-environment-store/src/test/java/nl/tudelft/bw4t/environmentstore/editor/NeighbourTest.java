...
public class NeighbourTest {
    ...
    @Test
    public void testAreasNeighbourNorth1(){
    ...
    @Test
    public void testAreasNeighbourNorth2(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
        rmodel.setDoor(0, true);
        rmodel.generateNameFromPosition(1,2);
    ...
    @Test
    public void testAreasNeighbourSouth1(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
    ...
    @Test
    public void testAreasNeighbourSouth(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
        rmodel.setDoor(2, true);
        rmodel.generateNameFromPosition(1,3);
    ...
    @Test
    public void testAreasNeighbourEast1(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
    ...
    @Test
    public void testAreasNeighbourEast2(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
        rmodel.setDoor(1, true);
        rmodel.generateNameFromPosition(1,4);
    ...
    @Test
    public void testAreasNeighbourWest1(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
    ...
    @Test
    public void testAreasNeighbourWest2(){
        ZoneModel rmodel = new ZoneModel(new Zone());
        rmodel.setType(Type.ROOM);
        rmodel.setDoor(3, true);
        rmodel.generateNameFromPosition(1,7);
