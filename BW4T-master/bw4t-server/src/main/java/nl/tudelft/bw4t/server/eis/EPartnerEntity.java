...
public class EPartnerEntity implements EntityInterface {
    ...
    public void initializePerceptionCycle() {
        ...
        ourEPartnerArea = AreaLocator.getAreaAt(ourEPartnerLocation.getX(), ourEPartnerLocation.getY());
    }
    ...
    public String getArea() {
        ...
        if (ourEPartnerArea == null) {
            return null;
        }
        return ourEPartnerArea.getName();
    }

    /**
     * Percept for the places in the world. Send at the beginning
     * 
     * @return Areas of the epartner
     * @throws PerceiveException
     */
    @AsPercept(name = "place", multiplePercepts = true, filter = Filter.Type.ONCE)
    public List<String> getAreas() throws PerceiveException {
