...
public abstract class AbstractRobot extends BoundedMoveableObject implements
	...
	public void moveTo(double x, double y) {
		...
		if (getLocation() != null) {
			...
			case ENTERING_ROOM:
				agentRecord.addEnteredArea(ZoneLocator.getZoneAt(x, y));
				break;
			case ENTER_CORRIDOR:
	...
	@Override
	public Area getCurrentArea(double x, double y) {
		for (Object o : getContext().getObjects(Area.class)) {
			Area room = (Area) o;
